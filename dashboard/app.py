...
if not hourly_df.empty:
    ...
    fig.update_layout(
        ...
        xaxis_title="Date & Time",
        yaxis_title="Value",
        xaxis=dict(showgrid=False),   # ✅ removed gridlines
        yaxis=dict(showgrid=True,gridcolor ="rgba(0,0,0,0.1)",griddash = "dot",gridwidth = 1)    # ✅ removed gridlines
    )
...
# --------------------------------------------------
# CURRENT WEATHER (BRIGHT TEXT FIX)
# --------------------------------------------------
st.markdown("---")
st.subheader("Current Weather")
...
if current_weather:
    ...
    w1.markdown(f"""
        <div>
            ...
            <div class="weather-value">{round(current_weather.get("temperature", 0), 2)}</div>
        </div>
    """, unsafe_allow_html=True)
    ...
    w2.markdown(f"""
        <div>
            ...
            <div class="weather-value">{round(current_weather.get("humidity", 0), 2)}</div>
        </div>
    """, unsafe_allow_html=True)
    ...
    w3.markdown(f"""
        <div>
            ...
            <div class="weather-value">{round(current_weather.get("wind_speed", 0), 2)}</div>
        </div>
    """, unsafe_allow_html=True)
    ...
    w4.markdown(f"""
        <div>
            ...
            <div class="weather-value">{round(current_weather.get("pressure", 0), 2)}</div>
        </div>
    """, unsafe_allow_html=True)
